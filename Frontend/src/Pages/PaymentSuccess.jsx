...
const PaymentSuccess = () => {
    ...
    try {
      const newBooking = {
        ...
        checkIn: searchParams.dates
          ? new Date(searchParams.dates.startDate)
              .toISOString()
              .split("T")[0]
          : "",

        checkOut: searchParams.dates
          ? new Date(searchParams.dates.endDate)
              .toISOString()
              .split("T")[0]
          : "",
  ...
  const subtotal =
    Number(property.price || 0) * nights;

  const fees = Math.max(
    0,
    Number(total || 0) - subtotal
  );
        ...
        <div className="mb-6 overflow-hidden rounded-[28px] bg-gradient-to-r from-blue-950 via-blue-900 to-blue-800 p-7 text-white shadow-xl sm:p-9">
          ...
          <div className="flex flex-col items-center text-center">
            ...
            <p className="mt-2 max-w-xl text-sm text-blue-100 sm:text-base">
              Your stay is booked successfully.
              Everything is ready for your upcoming trip.
            </p>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="mt-1 text-sm leading-6 text-blue-800">
                      ...
                      recorded. Keep your booking ID for
                      future reference.
                    </p>
              ...
              <div className="mt-5 flex items-center gap-3 rounded-2xl border border-blue-100 bg-blue-50 p-4">
                ...
                <div>
                  ...
                  <p className="mt-1 text-xs text-blue-700">
                    Your payment and booking information
                    are securely handled by FastBooking.
                  </p>
        ...
        <div className="mt-6 rounded-[28px] border border-slate-200 bg-white p-6 shadow-sm sm:p-8">
          ...
          <div className="mt-6 grid gap-4 md:grid-cols-3">
            ...
            <div className="rounded-2xl border border-slate-100 bg-slate-50 p-5">
              ...
              <p className="mt-2 text-sm leading-6 text-slate-600">
                Your property reservation has been
            ...
            <div className="rounded-2xl border border-slate-100 bg-slate-50 p-5">
              ...
              <p className="mt-2 text-sm leading-6 text-slate-600">
                Visit your account anytime to view or
                manage your booking.
              </p>
